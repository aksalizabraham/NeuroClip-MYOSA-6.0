...
excerpt: NeuroClip is a wearable ESP32-based prototype that detects abnormal movement using an MPU6050 and provides immediate local and remote caregiver alerts through an OLED, buzzer, Wi-Fi, Firebase, and a real-time web dashboard.
